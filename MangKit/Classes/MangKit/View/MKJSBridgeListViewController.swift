...
class MKJSBridgeListViewController: MKListController, UITableViewDataSource , UITableViewDelegate, UISearchResultsUpdating, UISearchControllerDelegate, DataCleaner{
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "MKListTableViewCell", bundle: MangUtil.sharedInstance().getBundle(forClass: MKJSBridgeListViewController.self)), forCellReuseIdentifier: NSStringFromClass(MKListTableViewCell.self)), forCellReuseIdentifier: NSStringFromClass(MKListTableViewCell.self))
