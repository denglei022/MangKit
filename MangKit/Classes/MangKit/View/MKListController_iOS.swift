...
class MKListController_iOS: MKListController, UITableViewDelegate, UITableViewDataSource, UISearchResultsUpdating, UISearchControllerDelegate, DataCleaner {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: NSStringFromClass(MKListTableViewCell.self), bundle: MangUtil.sharedInstance().getBundle(forClass: MKListController_iOS.self)), forCellReuseIdentifier: NSStringFromClass(MKListTableViewCell.self))
